...
public class BrowseExercise extends Fragment {

    private TableLayout browseExerciseTable;
    ...
    public static BrowseExercise newInstance(String param1, String param2) {
        BrowseExercise fragment = new BrowseExercise();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_browse_exercise, container, false);

        browseExerciseTable = (TableLayout) rootView.findViewById(R.id.browseExerciseTable);
        showExercise();
